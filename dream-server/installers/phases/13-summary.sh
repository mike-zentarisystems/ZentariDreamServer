...
[[ "${ENABLE_HERMES:-}" == "true" ]] && echo "  • Hermes Agent:  http://localhost:${SERVICE_PORTS[hermes-agent]:-8642}"
...
[[ "${ENABLE_AUTHELIA:-}" == "true" ]] && echo "  • Authelia SSO:  http://localhost:${SERVICE_PORTS[authelia]:-9091}"
[[ "${ENABLE_MONITORING:-}" == "true" ]] && echo "  • Grafana:       http://localhost:${SERVICE_PORTS[grafana]:-3007}"
[[ "${ENABLE_MONITORING:-}" == "true" ]] && echo "  • Prometheus:    http://localhost:${SERVICE_PORTS[prometheus]:-9090}"
[[ "${ENABLE_BASEROW:-}" == "true" ]] && echo "  • Baserow:       http://localhost:${SERVICE_PORTS[baserow]:-8110}"
[[ "${ENABLE_LANGFUSE:-}" == "true" ]] && echo "  • Langfuse:      http://localhost:${SERVICE_PORTS[langfuse]:-3006}"
echo ""
